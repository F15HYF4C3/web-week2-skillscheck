...
const me = {
	...
	age: 23,
	greeter: ()=>{
		return "Hello! " + me.firstName + " and I live in " + me.state;
	}
}
console.log(me);
//////////////////PROBLEM 12////////////////////
...
const reversed = arrayReverser(arr);
...
//const myNumbers = [3, 55, 788, 2, 1]
// Code Here
const filtered = myNumbers.filter(
	a =>{return a>100}
);
...
//const myNumbers = [3, 55, 788, 2, 1]
// Code Here
const total = myNumbers.reduce((i, myNumbers)=>{
	var total = [];
...
// Last, lets use .forEach to find the index of each item in the array. First, 
//create an empty array called myNumbersIndex. 
//Next, using forEach, 
//push each items index from the myNumbers array 
//to the myNumbersIndex array

// Code Here
const myNumbersIndex = [];
myNumbers.forEach(c => {
	var d = myNumbers[0];
	myNumbersIndex.push(myNumbers[d]);
	myNumbers[d]++;
},[0])
console.log(myNumbersIndex);
//I cant seem to figure out how to get the index to start at the first element....

//////////////////PROBLEM 18////////////////////

// Did you know that George Foreman has five sons named George? Let's go ahead and 
//change everyone's name in the notGeorge array 
//to George using .map. 
//Call the new array 'forTheLoveOfGeorge'
const notGeorge = ['Louis', 'Ted', 'Bill', 'Sharon', 'Mark', 'Angela']

// Code Here
const forTheLoveOfGeorge = notGeorge.map(f=>{
	return f = 'George';
})
...
// Code Here
var enemies = people.filter(function(people){
...
const totallyAwesome = people.reduce((i, currentVal, currIndex, people)=>{
	var totallyAwesome = [];
 totallyAwesome.push(people.awesomeLevel[i] + people.awesomeLevel[i]++);
