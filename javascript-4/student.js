...
// CODE HERE
const faveColors = ['blue', 'purple', 'silver'];
//////////////////Step 2////////////////////
...
const me = {
    firstName: 'Tyra',
    superHeroName: 'Absolute Zero',
    homeTown: 'Pleasant Grove',
    superPowers: ['Zero Gravity', 'Telekinesis', 'Water-Heal'],
    superPowerXP: ranmdomXP = function() {
        return Math.floor(Math.random() * 100 +1);},
    profileImage: pic = function(){
...
// CODE HERE
//arr is a parameter representitng an array
//this array, with an unknown .LENGTH, must never be longer than 3 elements... .splice
//.splice takes in an index and a quantity (x, y)- y is how many to eliminate after the index location of x...
//if y is set to 0, no items will be removed - Dont set any number to the y position, so it removes all?
//.splice should cut everything after the third item in the array, the third item would be index(2), 
//the fourth item is index(3)
//arr.length.splice(3, )
const setColor = (arr)=>{
arr.splice(3);
for(let i=0;i<=3 ; i++){
...
//const checkedOff = redactInfo(me);
