...
// Code Here
var groceries = ['bread', 'eggs', 'vitamins'];
//////////////////STEP 2////////////////////
...
console.log(setGroceryListTitle(yourName));
//////////////////STEP 4////////////////////
...
// Code Here
const checkGroceryCount = (array)=>{
    var groceryCount = "";
    console.log(array.length);
    if(array.length >= 5){
        groceryCount = "That looks like a big trip"
    }else
        if(array.length === 1){
        groceryCount = "1 item"
    }else if(array.length > 1 && array.length < 5){
        groceryCount = array.length + " items"
    }
    return groceryCount;
...
console.log(checkGroceryCount(groceries));
